...
describe BlacklightHelper do
  ...
  describe "#link_to_document" do
    ...
    context "when document has title" do
      it { should eql("<a target=\"_blank\" href=\"https://findingaids.library.nyu.edu/fales/testead/all/#123\">Guide to titling finding aids</a>") }
    end

    context "when document doesn't have title" do
      let(:solr_document) { create(:solr_document, unittitle: []) }

      it { should eql("<a target=\"_blank\" href=\"https://findingaids.library.nyu.edu/fales/testead/all/#123\">No Title</a>") }
    end
  end
